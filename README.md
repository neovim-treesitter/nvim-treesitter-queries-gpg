# nvim-treesitter-queries-gpg

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gpg/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gpg/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gpg**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gpg",
...
- [ ] Changes are scoped to `gpg` — do not include files for other languages
